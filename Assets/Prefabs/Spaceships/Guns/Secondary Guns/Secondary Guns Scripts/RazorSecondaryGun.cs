...
[CreateAssetMenu (menuName =("Secondary Guns/Razor"))]
public class RazorSecondaryGun : SecondaryGun
{
    public Image charge;
    public SpawningBullet bulletPrefab;
    public float damagePerSmallBullet;
    ...
    public override IEnumerator Shoot()
    {
        ...
        SpawningBullet bullet = Instantiate(bulletPrefab, p.firePoints[0].position, p.firePoints[0].rotation);
        bullet.pushBack = damagePerSmallBullet;
        bullet.damage = damagePerSmallBullet;
