...
public class CannonEnemy : Enemy
{
    ...
    IEnumerator ShootCannon()
    {
        ...
        Instantiate(muzzleFlash, firePoint.transform.position, Quaternion.Euler(firePoint.rotation.eulerAngles + (Vector3.forward * 45f)));
        cannonBullet = Instantiate(bulletPrefab, firePoint.position, Quaternion.Euler(firePoint.rotation.eulerAngles + (Vector3.forward * 45f)));
